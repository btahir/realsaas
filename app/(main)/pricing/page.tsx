import { getUser, getSubscription, getPlans } from '@/lib/supabase/server'
...
export default async function PricingPage() {
  ...
  let [user, subscription, plans] = await Promise.all([
    getUser(supabase),
  ...
  plans = plans
    ? plans.map((plan: any) => {
        return {
          ...
          isPopular: PLAN_DETAILS[plan.name].isPopular,
